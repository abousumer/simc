...
void demonology( player_t* p )
{
  ...
  default_->add_action ( "demonbolt,target_if=(!debuff.doom_brand.up|action.hand_of_guldan.in_flight&debuff.doom_brand.remains<=3),if=buff.demonic_core.up&(((!talent.soul_strike|cooldown.soul_strike.remains>gcd.max*2)&soul_shard<(4-(active_enemies>2)))|soul_shard<3)&!prev_gcd.1.demonbolt&set_bonus.tier31_2pc" );
