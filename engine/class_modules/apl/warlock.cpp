...
void demonology( player_t* p )
{
  ...
  racisl->add_action( "ancestral_call" );
...
void destruction( player_t* p )
{
  ...
  ogcd->add_action( "ancestral_call,if=variable.infernal_active|!talent.summon_infernal|(fight_remains<cooldown.summon_infernal.remains_expected+10+cooldown.fireblood.duration&fight_remains>cooldown.fireblood.duration)|fight_remains<cooldown.summon_infernal.remains_expected" );
